					...
					<div class="x_content">
						<div class="">
							<ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
								...
								<li role="presentation" class="active suppo_llng_li_add floattab"><a href="{!! url('/vehicletype/list/edit/'.$editid )!!}"><span class="visible-xs"></span><b><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i>{{ trans('app.Edit VehicleType')}}</b></a></li>
							</ul>
							<div class="clearfix"></div>
						</div>
						<div class="x_panel">
							<form action="update/{{ $vehicaltypes->id }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
							  ...
							  <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-top:30px;">
								...
								<div class="col-md-5 col-sm-5 col-xs-12">
								  <input type="text"  required="required" name="vehicaltype" value="{{ $vehicaltypes->vehicle_type }}" maxlength="30" class="form-control col-md-7 col-xs-12">
								</div>
							  </div>
