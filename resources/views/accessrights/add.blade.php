												...
												<div class="row">
													...
													<div class="col-12 col-md-6">
													  	<div class="form-group">
															...
															<select class="form-control" name="carera">
																<option value="country">Respublika uchun lavoziim</option>
																<option value="region">Viloyat uchun lavozim</option>
																<option value="district">Tuman uchun lavozim</option>
											...
											<div class="table-responsive">
												<table id="example-3" class="table table-striped table-bordered nowrap">
													<thead>
														<tr>
															<th width="5%">#</th>
															<th width="35%">Xarakat nomi</th>
															<th width="15%">Yaratish</th>
															<th width="15">Ko'rish</th>
															<th width="15%">O'zgartirish</th>
															<th width="15%">O'chirish</th>
														</tr>
													</thead>
													<tbody>
														@if(!empty($roles))
														<?php  $report = array('report_pay', 'report_new', 'report_exist', 'report_reg', 'report_old', 'setting', 'latest_income_republic'); ?>
														   <?php $i = 1; ?>   
