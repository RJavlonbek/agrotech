				...
				<div class="col-md-12">
					<div class="card">									
						<div class="card-body p-6">
							<div class="panel panel-primary">
								<div class="tab_wrapper page-tab">
									<ul class="tab_list">
										...
										<li class="active">
											<a href="{!! url('/locker/list/edit/'.$editid )!!}">
												<span class="visible-xs"></span>
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">
									<form action="update/{{ $locker->id }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
										<div class="row">
											<div class="col-12 col-md-6">
											  	<div class="form-group">
													<label class="form-label" for="first-name">Taqiqqa oluvchi <label class="text-danger">*</label>
													</label>
												  	<input type="text"  required="required" name="vehicaltype" value="{{ $locker->name }}" class="form-control">
												</div>
											</div>
									  		<div class="col-12 col-md-6">
