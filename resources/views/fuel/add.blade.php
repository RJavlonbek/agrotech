						...
						<div class="col-md-12">
							<div class="card">									
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<form  action="{{ url('/fuel/store') }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
												<div class="row">
													<div class="col-12 col-md-6">
													  	<div class="form-group">
															<label class="form-label" for="first-name">Yonilg'i turi<label class="text-danger">*</label>
															</label>
															<input type="text"  required="required" name="fuel" placeholder="Yonilg'i turini kiriting" class="form-control"
															>
													  	</div>
													</div>
