	...
	<div class="section" id="report-page">
        <div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form action="{{ url('/report/income/registrations') }}" method="get">
							...
							<div class="row">
								<div class="col-md-4">
									...
									@endif
									<select class="form-control" id="search" name="state" required>
										@if(!empty($states))
						...
						<div class="card-body">
							<div class="row mb-2">
								...
								<div class="col-4 text-right">
									...
									<div class="btn btn-primary" id="export-excel" 
										filename="{{$state?$state->name:'-'}}-{{$action=='regged' ? 'texnika ro\'yxatga olish' : 'texnika ro\'yxatdan chiqarish'}} tushumlar {{date('d.m.Y')}}"><i class="fa fa-file-excel-o"></i> Excel ga jo'natish</div>	
								</div>									
							</div>
							<div class="">
									...
									<table class="table table-bordered" id="report">
										<thead>
											<tr class="sticky-header">
												...
												<th colspan="8">
													<span class="font-weight-bold">{{$action=='regged' ? 'Ro\'yxatga olingan texnikalar' : 'Ro\'yxatdan chiqarilgan texnikalar'}}</span>
												</th>
											</tr>
