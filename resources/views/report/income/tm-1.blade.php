    	...
    	<div class="section" id="report-page">
	        <div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							<form action="{{ url('/report/income/tm-1') }}" method="get">
							...
							<div class="card-body">
								<div class="row mb-2">
									<div class="report-header fs-16 col-8">
										...
										@elseif(!empty($city))
											<span><b>{{$city->name}}</b>da <b>TM-1 ma'lumotnomalardan</b> kelib tushgan tushumlar bo'yicha <b>{{date('d.m.Y')}}</b> holatiga ma'lumot</span>
										@else
											<span>TM-1 ma'lumotnoma tushum - hisobot</span>
										@endif
									</div>
									<div class="col-4 text-right">
										<div class="btn btn-primary print-table-button" table="report" ><i class='fa fa-print'></i> Chop etish</div>
										<div class="btn btn-primary" id="export-excel" filename="{{$state?$state->name:$city->name}}-TM-1 ma'lumotnoma tushumlar {{date('d.m.Y')}}"><i class="fa fa-file-excel-o"></i> Excel ga jo'natish</div>	
									</div>									
								</div>
								<div class="">
										...
										<table class="table table-bordered" id="report">
											<thead>
												<tr class="sticky-header">
													...
													<th colspan="8">
														<span class="font-weight-bold">Berilgan TM-1 ma'lumotnomalar</span>
													</th>
												</tr>
												...
												<tr class="sticky-header sticky-height2">
													<th class="sticky-custom2" rowspan="1">
														soni, dona
													</th>
													<th class="sticky-custom2" rowspan="1">
														Summasi, mln so'm
