    	...
    	<div class="section" id="report-page">
	        <div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							<form action="{{ url('/report/income/transport-numbers') }}" method="get">
							...
							<div class="card-body">
								<div class="row mb-2">
									<div class="report-header fs-16 col-8">
										...
										@elseif(!empty($city))
											<span><b>{{$city->name}}</b>da <b>davlat raqami belgilaridan</b> kelib tushgan tushumlar bo'yicha <b>{{date('d.m.Y')}}</b> holatiga ma'lumot</span>
										@else
											<span>Davlat raqami belgilari tushum - hisobot</span>
										@endif
									</div>
									<div class="col-4 text-right">
										<div class="btn btn-primary print-table-button" table="report" ><i class='fa fa-print'></i> Chop etish</div>
										<div class="btn btn-primary" id="export-excel" filename="{{$state?$state->name:$city->name}}-davlat raqami tushumlar {{date('d.m.Y')}}"><i class="fa fa-file-excel-o"></i> Excel ga jo'natish</div>
									</div>
								</div>
								<div class="">
										...
										<table class="table table-bordered" id="report">
											<thead>
												<tr class="sticky-header">
													...
													@if($type=='1,2')
														<th colspan="9">
															<span class="font-weight-bold">Yuridik o'ziyurarlarga davlat raqami belgisi berish</span>
														</th>
														<th colspan="9">
															<span class="font-weight-bold">Jismoniy o'ziyurarlarga davlat raqami belgisi berish</span>
														</th>
													@elseif($type='3,4')
														<th colspan="9">
															<span class="font-weight-bold">Yuridik tirkamalarga davlat raqami belgisi berish</span>
														</th>
														<th colspan="9">
															<span class="font-weight-bold">Jismoniy tirkamalarga davlat raqami belgisi berish</span>
														</th>
													@endif
												</tr>
												<tr class="sticky-header sticky-height1">
													...
													<th class="sticky-custom" rowspan="3" >
														Qoldiq soni, dona
													</th>
													<th class="sticky-custom" colspan="4">
														Oyda
...
<script>
	$(document).ready(function() {
		var height1 = parseFloat($('.height').height());
