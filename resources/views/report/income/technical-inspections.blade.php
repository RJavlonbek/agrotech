    	...
    	<div class="section" id="report-page">
	        <div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							<form action="{{ url('/report/income/technical-inspections') }}" method="get">
							...
							<div class="card-body">
								<div class="row mb-2">
									<div class="report-header fs-16 col-8">
										...
										@elseif(!empty($city))
											<span><b>{{$city->name}}</b>da <b>majburiy texnik ko'riklardan</b> kelib tushgan tushumlar bo'yicha <b>{{date('d.m.Y')}}</b> holatiga ma'lumot</span>
										@else
									...
									<div class="col-4 text-right">
										...
										<div class="btn btn-primary" id="export-excel" filename="{{$state?$state->name:$city->name}}-texnik ko'rik tushumlar {{date('d.m.Y')}}"><i class="fa fa-file-excel-o"></i> Excel ga jo'natish</div>
									</div>
								</div>
								<div class="">
										...
										<table class="table table-bordered" id="report">
											<thead>
												<tr class="sticky-header">
													...
													<th colspan="12">
														<span class="font-weight-bold">Majburiy texnik ko'rik</span>
													</th>
												</tr>
												...
												<tr class="sticky-header sticky-height2">
													...
													<th class="sticky-custom2" colspan="2">
														Traktor, tirkama va o'ziyurarlar
													</th>
