...
$(function(e) {
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#0052cc', '#0099ff', '#21c44c', '#ffb209', '#ff1a1a', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	/* ---hightchart4----*/
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#21c44c', '#ff1a1a', '#ffb209', '#0052cc', '#0099ff'],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#21c44c', '#ffb209', '#0099ff', '#0052cc', '#ff5c75'],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	var chart = Highcharts.chart('highchart7', {
		...
		colors: ['#0052cc', '#0099ff', '#21c44c', '#ffb209', '#ff1a1a', '#FF9655', '#f1c40f', '#6AF9C4'],
		series: [{
			type: 'column',
			colorByPoint: true,
