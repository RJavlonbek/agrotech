						...
						<div class="col-md-12">
							<div class="card">									
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<form action="{{ url('/customer/category/store') }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
												<div class="row">
													<div class="col-12 col-md-6">
													  	<div class="form-group">
															<label class="form-label" for="first-name">Kategoriya <label class="text-danger">*</label>
															</label>
															<input type="text"  required="required" name="name" placeholder="Kategoriya nomini kiriting" class="form-control">
													  	</div>
													</div>
