								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<form action="/supplier/store" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
												...
												<div class="row">
													...
													<div class="col-12 col-md-6">
													  	...
													  	<div class="form-group">
															...
															<label class="form-label" for="first-name">{{ trans('app.Supplier Name')}} 

															</label>

															<input type="text"  required="required" name="name" placeholder="{{ trans('app.Enter supplier name')}}" class="form-control">
