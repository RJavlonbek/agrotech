				...
				<div class="col-md-12">
					<div class="card">									
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">
									<form action="update/{{ $city->id }}" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
										<div class="row">
											<div class="col-12 col-md-6">
												<label class="form-label" for="first-name">{{ trans('app.City Name')}} <label class="text-danger">*</label>
												</label>
												<input type="text"  required="required" name="city" value="{{ $city->name }}"  class="form-control">
											</div>
											<div class="col-12 col-md-6">
