...
{	
	...
	{	
		...
		$totalstock1=DB::table('tbl_purchase_history_records')
			...
			//$common_array = array_merge($totalstock1,$cellstock1);
	...
	{	
...

		{
			...
			$servicereport = DB::table('tbl_services')->where('done_status','=',1)
													...
													->whereBetween('service_date', array($s_date, $e_date))->where('assign_to','=',$all_employee)->get()->toArray();
